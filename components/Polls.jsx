...
const Polls = () => {
  ...
  return (
    <>
      ...
      <Text style={{ fontSize: 14, color: '#000', fontFamily: 'MavenPro-SemiBold', marginBottom: 20 }}>Daily Opinions</Text>

        {loading ? (
          <View style={{ height: '52%', justifyContent: 'center', alignItems: 'center', backgroundColor: '#fff' }}>
